    ...
    <section class="project-section">
        <div class="auto-container">
            <div class="sec-title centered">
                <h2><span class="theme_color">Our</span> {{$service->name}} Products </h2>
            </div>
                ...
                <div class="filters clearfix">
                    <ul class="filter-tabs filter-btns clearfix">
                        ...
                        @foreach($sub_cats as $sub_cat)
                            <li class="filter" data-role="button" data-filter="{{'.'.$sub_cat->title}}">{{$sub_cat->title}}</li>
                        @endforeach
                    </ul>
                </div>

                <div class="filter-list row clearfix">
                    @foreach($projects_p as $project)
                                ...
                                <figure class="image-box">
                                    ...
                                    <div class="overlay-box">
                                        <div class="overlay-inner">
                                            ...
                                            <div class="content">
                                                <h3><a href="{{url('project-details?id='.$project->p_id)}}">{{$project->name}}</a></h3>
